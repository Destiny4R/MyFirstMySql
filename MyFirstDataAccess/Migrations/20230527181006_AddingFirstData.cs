    ...
    public partial class AddingFirstData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StudentRegNo = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    LocalGov = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PlaceOfBirth = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    UserID = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RegisterBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SN = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassesInSchools", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StudentRegNo",
                table: "AspNetUsers",
                column: "StudentRegNo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassesInSchools_ClassName",
                table: "ClassesInSchools",
                column: "ClassName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SessionYears_Name",
                table: "SessionYears",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubClasses_ClassName",
                table: "SubClasses",
                column: "ClassName",
                unique: true);
        }
